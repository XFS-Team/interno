...
<div class="container mt-[200px] flex gap-[97px]">
  ...
  <div class="max-w-[655px]">
    <Text class="text-justify" color="tertiary"
      >It is a long established fact that a reader will be distracted by the of
      readable content of a page</Text
    >
    <Text class="text-justify mt-8"
      ...
      like thesce sweet morndsings of sphring which I enjoy with my forwhole
      heart. I am alone, and feel the charm of excgistence in this spot, which
      was created for the bliss of souls like mine.</Text
    >
    <Text class="text-justify mt-7"
      >when lookings at its layouts the points spriof using that it has a more
      less normal.A wonderful serenity has taken pgossession of my entire soul,
      like thesce sweet morndsings of sphring which I enjoy with my forwhole
      heart. I am alone, and feel the charm of excgistence in this spot, which
